        ...
        do{
            ...
            switch (op){
                case 1:
                    ...
                    case 3:
                        System.out.println(" Digite id usuario:");
                        id = scanner.nextInt();
                    ...
                    case 4:
                        ...
                        if(resultUser == null)
                            ...
                            switch(op){
                                case 1: resultUser.nome = temp;
                                break;
                                case 2: resultUser.email = temp;
                                    break;
                                case 3: resultUser.senha = temp;
                                    break;

                            }
                            usuariosDAO.updateUserById(resultUser);
                        }
                        break;
